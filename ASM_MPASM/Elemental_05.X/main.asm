;**************************************************************************************
; PROYECTO: Elemental_05 - Introduccion a las mascaras de Bits
; AUTOR: Carlos Mamani Flores (UTN-FRT)
; DESCRIPCIÓN: Lee RA<4:0> y se muestra el resultado en RB<7:0> pero con los bits
;invertidos. -
;**************************************************************************************
...
;--- CAPA 1: MAPEO DE HARDWARE Y CONSTANTES ---
    ...
    MASCARA_XOR	EQU	b'00011111'	; Mascara de bits para invertir los bits
...
MAIN
    ...
    XORLW   MASCARA_XOR		    ;Aplico la mascara para mantener apagado los bits impares
